...
public class MultiMotor extends SensorBase implements SpeedController {
	...
	/**
	 * @param motorList list of SpeedControllers
	 * @throws ClassCastException if the list is not a list of SpeedControllers
	 * @throws IllegalArgumentException if list is empty
	 */
	public MultiMotor(List motorList) throws ClassCastException, IllegalArgumentException{
